...
namespace Dgmjr.Enumerations.CodeGenerator
{
    public static class Constants
    {
        ...
        */
        ...
        public const string GenerateEnumerationRecordStructAttribute = nameof(GenerateEnumerationRecordStructAttribute);
        public const string GenerateEnumerationRecordClassAttribute = nameof(GenerateEnumerationRecordClassAttribute);
        public const string GenerateEnumerationStructAttribute = nameof(GenerateEnumerationStructAttribute);
        public const string GenerateEnumerationClassAttribute = nameof(GenerateEnumerationClassAttribute);

        public static readonly string[] AttributeClasses = new[] { GenerateEnumerationClassAttribute, GenerateEnumerationRecordClassAttribute, GenerateEnumerationRecordStructAttribute, GenerateEnumerationStructAttribute };

        public const string GenerateEnumerationTypeAttributes = nameof(GenerateEnumerationTypeAttributes);

        public static readonly Scriban.Template HeaderTemplate = Scriban.Template.Parse(Header);

        public static string HeaderFilledIn(string filename) => HeaderTemplate.Render(new { filename, toolName = ThisAssembly.Info.Title, toolVersion = ThisAssembly.Info.Version, timestamp = DateTimeOffset.Now });
        ...
        public static readonly string EnumerationRecordStructDeclaration = typeof(Constants).Assembly.ReadAssemblyResourceAllText($"{EnumerationRecordStruct}.{scriban}");
        public static readonly string EnumerationStructDeclaration = typeof(Constants).Assembly.ReadAssemblyResourceAllText($"{EnumerationStruct}.{scriban}");

        public static readonly Scriban.Template EnumerationRecordStructDeclarationTemplate = Scriban.Template.Parse(EnumerationRecordStructDeclaration);
        public static readonly Scriban.Template EnumerationStructDeclarationTemplate = Scriban.Template.Parse(EnumerationStructDeclaration);
    }
}
